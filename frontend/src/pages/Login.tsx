  ...
  const roles = [
    {
      ...
      theme: "indigo",
      colorClass:
        "hover:border-indigo-500/50 group-hover:text-indigo-400 hover:shadow-indigo-500/20",
    },
    {
      id: "head" as const,
      title: "Track Head",
      ...
      theme: "emerald",
      colorClass:
        "hover:border-emerald-500/50 group-hover:text-emerald-400 hover:shadow-emerald-500/20",
    },
    {
      id: "hr" as const,
      title: "HR Auditor",
      ...
      theme: "violet",
      colorClass:
        "hover:border-violet-500/50 group-hover:text-violet-400 hover:shadow-violet-500/20",
    },
  ];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#050505] via-[#0B0B12] to-[#14142B] text-slate-200 selection:bg-brand/30 overflow-hidden relative font-sans">
      ...
      <main className="relative z-10 w-full max-w-6xl px-6 py-12">
        <header className="text-center mb-16 space-y-4">
          ...
          >
            Secure platform for managing members, evaluations, and leadership
            operations.
          </motion.p>
        </header>
...
${role.colorClass}`}
        ...
        <footer className="mt-20 text-center">
          <p className="text-neutral-600 text-xs font-medium tracking-widest uppercase">
            Developed by <span className="text-neutral-400">Ahmed Magdy</span>{" "}
            &copy; 2026
          </p>
        </footer>
      </main>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <div className="relative flex items-center justify-center gap-2 bg-neutral-950 rounded-[15px] px-8 py-4 transition-all group-hover:bg-transparent">
                    ...
                    {!loading && (
                      <ArrowRight className="w-4 h-4 text-white group-hover:text-neutral-950 transition-transform group-hover:translate-x-1" />
                    )}
                  </div>
                </button>
              </form>
